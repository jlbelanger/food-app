			...
			<nav className="contain" id="nav">
				{Auth.isLoggedIn() ? (
					<>
						...
						<NavLink activeClassName="nav__link--active" className="nav__link" to="/calendar">Calendar</NavLink>
						<NavLink activeClassName="nav__link--active" className="nav__link" to="/charts">Charts</NavLink>
